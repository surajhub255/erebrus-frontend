...
const Contact = () => {
  ...
  return (
    <div
      id="features"
      className="scroll-mt-40 w-full flex flex-col items-center justify-center h-screen"
    >
      <div className="border rounded-lg bg-white text-black p-4">
        <div className="text-center mb-12">
          <h2 className="font-bold text-4xl lg:text-5xl lg:mb-20 mb-4">
            Sign Up for Beta!
          </h2>
        </div>
