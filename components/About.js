...
const About = () => {
  return (
    <div
      id="about"
      className="flex flex-col items-center justify-center scroll-mt-56"
    >
      ...
      <div className="lg:w-[50%] w-[60%]">
        <h1 className="text-2xl lg:text-2xl font-figtree font-bold opacity-50 text-gray-400 mb-80">
